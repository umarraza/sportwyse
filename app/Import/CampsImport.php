...
class CampsImport
{
    public static function import($camp, $club)
    {
        ...
        $club->camps()->create([
            ...
            'processing_fee_using_credit_card' => $camp->processingFee,
            'total_price_using_credit_card' => $camp->fullPaymentProcessingFee,
            'processing_fee_using_bank_account' => $camp->bankAccountProcessingFee,
            'total_price_using_bank_account' => $camp->fullBankAccountPaymentProcessingFee,
