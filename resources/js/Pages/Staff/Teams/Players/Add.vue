        ...
        <div class="card m-b-30">
          <div class="card-header">
            ...
            <div class="card-header-right">
              <BackToList :backToListRoute="route('staff.teams.players.index', team.id)" class="btn btn-primary">
              </BackToList>
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-12 text-right">
                <Link :href="route('staff.teams.players.index', team.id)" class="btn btn-secondary mr-1">
                Cancel
                </Link>
...
const submitForm = () => {
  form.post(route('staff.teams.players.store', props.team.id), {
    onFinish: (response) => {
