          ...
          <div class="card-body">
            <form @submit.prevent="submit">
              ...
              <div class="row mt-2">
                <div class="col-md-4">
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="allAssigned">Assigned (Event & Player): {{ allAssignedCount
                    }}</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="assignedByEvent">Assigned (By Event): {{ assignedByEventCount
                    }}</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="assignedByPlayer">Assigned (By Player): {{
                      assignedByPlayerCount }}</label>
                  </div>
                </div>
              </div>
              <div class="row mt-3">
                <div class="col-md-4">
                  <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="allUnAssigned" v-model="filters.allUnAssigned"
                      data-parsley-multiple="groups" data-parsley-mincheck="2">
                    <label class="custom-control-label" for="allUnAssigned">Pending (Event & Player): {{ unAssignedCount
                    }}</label>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="unAssignedByEvent">Pending (By Event): {{
                      unAssignedByEventCount }}</label>
                  </div>
                </div>
                ...
                <div class="col-md-4">
                  <div class="custom-control custom-checkbox">
                    ...
                    <label class="custom-control-label" for="unAssignedByPlayer">Pending (By Player): {{
                      unAssignedByPlayerCount }}</label>
                  </div>
                </div>
              </div>
              <div class="row mt-3">
              ...
              <div class="form-group text-right mt-3">
                ...
                <button type="button" class="btn btn-success waves-effect ml-1 waves-light" data-toggle="modal"
              ...
              <div class="row mt-5">
                <div class="col-md-12">
                  <div class="alert alert-success text-center" role="alert"
                    v-if="totalFailedTransactionsCount === allAssignedCount">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th @click="orderByParam('description')">Player Name (Old) <i
                              class="fas fa-long-arrow-alt-up"></i><i class="fas fa-long-arrow-alt-down"></i></th>
                          <th>Status</th>
                          <th @click="orderByParam('created_date')">Created Date <i
                              class="fas fa-long-arrow-alt-up"></i><i class="fas fa-long-arrow-alt-down"></i></th>
                          <th>Customer ID</th>
